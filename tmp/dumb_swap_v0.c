...
int main() {
    ...
    //     // Create tokens
    //     int token1 = tokenAmount1;

    //     // Create UTxO
    //     int ownerID = rand() % 2; // Non-deterministic owner ID
    //     UTxO* utxo = createUTxO(ownerID, token1);
    ...
    // // Clean up memory
    // printf("INFO: Cleaning up utxos pointers\n");
    // for (int i = 0; i < ledger->numTransactions; i++) {
    //     printf("Cleaning transaction %d\n",i);
    //     UTxO* utxo = ledger->unspentTransactions[i];
    //     printUTxO(utxo);
    //     free(utxo);
    // }
    // printf("INFO: Cleaning up ledger\n");
